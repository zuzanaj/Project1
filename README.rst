################################################################################
Cookiecutter_project1
################################################################################

my first project, SurfSARA
...
* The ``tests`` folder contains:
  ...
  - Example tests that you should replace with your own meaningful tests (file: ``test_project1``)
...
* For convenience, the package version is stored in a single place: ``Project1/__version__.py``. For updating the version number, you only have to change this file.
...
If you want to contribute to the development of Cookiecutter_project1,
